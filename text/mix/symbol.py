...
# 韵母：41
_yunmu = [
    'a', 'ai', 'an', 'ang', 'ao', 'e', 'ei', 'en', 'eng', 'er', 'i', 'ia', 'ian', 'iang', 'iao', 'ie', 'ii', 'iii', 'in', 'ing',
    'iong', 'iou', 'o', 'ong', 'ou', 'u', 'ua', 'uai', 'uan', 'uang', 'ueng', 'uei', 'uen', 'uo', 'v',
    'van', 've', 'vn', 'ng', 'uong'
]
...
symbol_chinese = [_pad, _eos, _chain] + _shengmu + [i + j for i in _yunmu for j in _shengdiao] + _alphabet + _english + _biaodian + _other
